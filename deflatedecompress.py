# Extract an incomplete DEFLATE stream. Based on original code by Project
# Nayuki. Original copyright below:
#
...
class Decompressor(object):
        ...
        def readBlock(self):
                ...
                isfinal = self._input.read_no_eof() == 1  # bfinal
        ...
        def curPos(self):
            posB = self._input._input.tell()
            if self._input._num_bits_remaining > 0:
                posB -= 1
            return posB*8 + self._input.get_bit_position()
